...
![image-20231110193214624](mysql-series-19-transaction-log/image-20231110193214624.png)
...
![image-20231110194328602](mysql-series-19-transaction-log/image-20231110194328602.png)
...
![image-20231110194915124](mysql-series-19-transaction-log/image-20231110194915124.png)

### redo log 的整体流程

以一个更新事务为例，redo log 的流转过程，如下图所示：

![image-20231110195130060](mysql-series-19-transaction-log/image-20231110195130060.png)
...
![image-20231110195627970](mysql-series-19-transaction-log/image-20231110195627970.png)
...
![image-20231110204145340](mysql-series-19-transaction-log/image-20231110204145340.png)

**也就是说，一个没有提交事务的 redo log 记录，也可能会刷盘。因为在事务执行过程 redo log 记录是会写入 redo log buffer 中，这些 redo log 记录会被后台线程刷盘。**

![image-20231110204328011](mysql-series-19-transaction-log/image-20231110204328011.png)
...
![image-20231110204709173](mysql-series-19-transaction-log/image-20231110204709173.png)
...
![image-20231110211552048](mysql-series-19-transaction-log/image-20231110211552048.png)
...
![image-20231110212019323](mysql-series-19-transaction-log/image-20231110212019323.png)
...
![image-20231110213606186](mysql-series-19-transaction-log/image-20231110213606186.png)
...
![image-20231110214215918](mysql-series-19-transaction-log/image-20231110214215918.png)
...
![image-20231110214607022](mysql-series-19-transaction-log/image-20231110214607022.png)
...
![image-20231110215030086](mysql-series-19-transaction-log/image-20231110215030086.png)
...
![image-20231110215410008](mysql-series-19-transaction-log/image-20231110215410008.png)

**真正的 redo log 都是存储到占用 496 字节大小的 log block body 中，图中的 log block header 和 log block trailer 存储的是一些管理信息。**我们来看看这些所谓的管理信息都有什么。

![image-20231110215536304](mysql-series-19-transaction-log/image-20231110215536304.png)
...
![image-20231111095945175](mysql-series-19-transaction-log/image-20231111095945175.png)
...
![image-20231111102851434](mysql-series-19-transaction-log/image-20231111102851434.png)

如果 write pos 追上 checkpoint ，表示日志文件组满了，这时候不能再写入新的 redo log 记录，MySQL 得停下来，清空一些记录，把 checkpoint 推进一下。

![image-20231111102951774](mysql-series-19-transaction-log/image-20231111102951774.png)

### 小结

InnoDB 的更新操作，采用的是 Write Ahead Log（预先日志持久化）策略，即先写日志，再写入磁盘：

![image-20231111103139939](mysql-series-19-transaction-log/image-20231111103139939.png)
...
![image-20231111181508120](mysql-series-19-transaction-log/image-20231111181508120.png)

有了 redo log 和 undo log 之后：

![image-20231111181600020](mysql-series-19-transaction-log/image-20231111181600020.png)
...
![image-20231111183414685](mysql-series-19-transaction-log/image-20231111183414685.png)
...
![image-20231111183619474](mysql-series-19-transaction-log/image-20231111183619474.png)
...
![image-20231111183825711](mysql-series-19-transaction-log/image-20231111183825711.png)
...
![image-20231111184027834](mysql-series-19-transaction-log/image-20231111184027834.png)
...
![image-20231111215246241](mysql-series-19-transaction-log/image-20231111215246241.png)
