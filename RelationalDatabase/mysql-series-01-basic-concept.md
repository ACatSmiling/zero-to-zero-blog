...
![image-20220531223454362](mysql-series-01-basic-concept/image-20220531223454362.png)

![image-20220531223704029](mysql-series-01-basic-concept/image-20220531223704029.png)
...
![image-20220601131827935](mysql-series-01-basic-concept/image-20220601131827935.png)
...
- 档案信息表（不常用信息）：学号、身份证号码、家庭住址、籍贯、紧急联系人、...
  ...
  ![image-20220601132459103](mysql-series-01-basic-concept/image-20220601132459103.png)
...
![image-20220601133318896](mysql-series-01-basic-concept/image-20220601133318896.png)
...
- 部门表：编号、名称、简介。
  ...
  ![image-20220601133524961](mysql-series-01-basic-concept/image-20220601133524961.png)

  ![image-20220601133540109](mysql-series-01-basic-concept/image-20220601133540109.png)

#### 多对多关联（many-to-many）

要表示多对多关联，必须创建第三个表，该表通常称为`联接表`，它将多对多关系划分为两个一对多关系。将这两个表的主键都插入到第三个表中。

![image-20220601133833826](mysql-series-01-basic-concept/image-20220601133833826.png)
...
- 选课信息表 ：一个学生可以选多门课，一门课可以被多个学生选择。
  ...
  ![image-20220601140500467](mysql-series-01-basic-concept/image-20220601140500467.png)
...
- 订单明细表 ：每个产品可以与订单表中的多条记录对应，即出现在多个订单中。一个订单可以与产品表中的多条记录对应，即包含多个产品。
  ...
  ![image-20220601140146835](mysql-series-01-basic-concept/image-20220601140146835.png)

举例 3：用户-角色

- 一个用户，可能存在多个角色。

  ![image-20220601140424296](mysql-series-01-basic-concept/image-20220601140424296.png)

#### 自我引用（Self reference）

![image-20220601140611310](mysql-series-01-basic-concept/image-20220601140611310-1726673713161-10.png)
...
![image-20220912195710669](mysql-series-01-basic-concept/image-20220912195710669.png)
