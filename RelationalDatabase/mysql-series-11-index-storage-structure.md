...
![image-20230604194836752](mysql-series-11-index-storage-structure/image-20230604194836752.png)
...
![image-20230604201705988](mysql-series-11-index-storage-structure/image-20230604201705988.png)
...
![image-20230604222626409](mysql-series-11-index-storage-structure/image-20230604222626409.png)
...
![image-20230606222031940](mysql-series-11-index-storage-structure/image-20230606222031940.png)
...
![image-20230606222415698](mysql-series-11-index-storage-structure/image-20230606222415698.png)

把一些记录放到页里的示意图就是：

![image-20230606222456421](mysql-series-11-index-storage-structure/image-20230606222456421.png)
...
![image-20230606223417885](mysql-series-11-index-storage-structure/image-20230606223417885.png)
...
![image-20230606223803991](mysql-series-11-index-storage-structure/image-20230606223803991.png)
...
![image-20230606224336967](mysql-series-11-index-storage-structure/image-20230606224336967.png)
...
![image-20230606224717097](mysql-series-11-index-storage-structure/image-20230606224717097.png)
...
![image-20230606225951386](mysql-series-11-index-storage-structure/image-20230606225951386.png)
...
![image-20230607125107306](mysql-series-11-index-storage-structure/image-20230607125107306.png)
...
![image-20230607222538285](mysql-series-11-index-storage-structure/image-20230607222538285.png)
...
![image-20230607224258033](mysql-series-11-index-storage-structure/image-20230607224258033.png)
...
![image-20230607225042258](mysql-series-11-index-storage-structure/image-20230607225042258.png)
...
![image-20230608084834004](mysql-series-11-index-storage-structure/image-20230608084834004.png)
...
![image-20230608170017250](mysql-series-11-index-storage-structure/image-20230608170017250.png)
...
![image-20230608174847310](mysql-series-11-index-storage-structure/image-20230608174847310.png)
...
![image-20230608183334269](mysql-series-11-index-storage-structure/image-20230608183334269.png)
...
![image-20230608184249919](mysql-series-11-index-storage-structure/image-20230608184249919.png)
...
![image-20230608190007313](mysql-series-11-index-storage-structure/image-20230608190007313.png)
...
![image-20230608192657521](mysql-series-11-index-storage-structure/image-20230608192657521.png)
...
![image-20230609084235249](mysql-series-11-index-storage-structure/image-20230609084235249.png)
...
![image-20230609225644661](mysql-series-11-index-storage-structure/image-20230609225644661.png)
...
![image-20230609230018470](mysql-series-11-index-storage-structure/image-20230609230018470.png)

上图中哈希函数 h 有可能将两个不同的关键字映射到相同的位置，这叫做`碰撞`，在数据库中一般采用`链接法`来解决。在链接法中，将散列到同一槽位的元素放在一个链表中，如下图所示：

![image-20230609230131645](mysql-series-11-index-storage-structure/image-20230609230131645.png)
...
![image-20230610113415311](mysql-series-11-index-storage-structure/image-20230610113415311.png)
...
![image-20230610134916578](mysql-series-11-index-storage-structure/image-20230610134916578.png)

但是存在特殊的情况，会导致二叉树的深度非常大。比如数列 (5, 22, 23, 34, 77, 89, 91)，创造出来的二分搜索树，就如下图所示：

![image-20230610135121934](mysql-series-11-index-storage-structure/image-20230610135121934.png)
...
![image-20230610143108677](mysql-series-11-index-storage-structure/image-20230610143108677.png)
...
![image-20230610143426258](mysql-series-11-index-storage-structure/image-20230610143426258.png)
...
![image-20230610172506961](mysql-series-11-index-storage-structure/image-20230610172506961.png)

详细说明：

![image-20230610190229738](mysql-series-11-index-storage-structure/image-20230610190229738.png)
...
![image-20230610211455750](mysql-series-11-index-storage-structure/image-20230610211455750.png)
...
![image-20230610235443346](mysql-series-11-index-storage-structure/image-20230610235443346.png)
...
![image-20230611000205390](mysql-series-11-index-storage-structure/image-20230611000205390.png)
